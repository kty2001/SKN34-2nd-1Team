...
### 🏠 개인 헬스장
트레이너의 1:1 밀착 관리와 출석 리워드, 친구 추천 등을 활용해 회원의 운동 지속과 재계약을 유도한다.

### 🏢 체인 헬스장
연예인·인플루언서 협업, 한정판 굿즈, 장기계약 프로모션 등 규모를 활용한 마케팅으로 방문과 장기 이용을 유도한다.

### 📌 공통 대책
가입 초기·방문 감소·단기계약 회원을 집중 관리하고, 다양한 혜택을 통해 이탈을 예방하며 장기계약 전환을 유도한다.
